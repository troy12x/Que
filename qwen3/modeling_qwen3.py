...
from .infinityformer_attention import InfinityFormerAttention
...
class Qwen3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        # PARAMETER SURGERY: Use our custom attention module instead of the default
        self.self_attn = InfinityFormerAttention(config=config, layer_idx=layer_idx)
